...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `archived` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
  `date_format` VARCHAR(15) NOT NULL  COLLATE utf8mb4_hungarian_ci DEFAULT 'yyyy-MM-dd',
  `time_format` VARCHAR(10) NOT NULL COLLATE utf8mb4_hungarian_ci DEFAULT 'HH:mm',
